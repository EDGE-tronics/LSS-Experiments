/* autogenerated by Processing revision 1281 on 2022-11-10 */
...
long time = millis();
 ...
 public void setup() {
  ...
  createList("COMmenu", width-65, headerHeight*0.7f, 60, 3*30, Arrays.asList(" OFF", " USB"), 0);
  ...
  haltButton = createButton("HOLD", "HOLD", cp5.getController("BAUDmenu").getPosition()[0]-65, headerHeight*0.7f, 60, 30);
 ...
 public void drawHeader() {
  ...
  image(logo, -1/2*width, -1/2*height+0.1f*headerHeight, 2.4f*headerHeight, headerHeight);
}
 ...
 public void mousePressed() {
  ...
  if (infoButton.isOn()) {
    if (mouseX >= 0.8f*width){
      ...
      else if (mouseY >= headerHeight*0.65f+40 && mouseY < headerHeight*0.65f+60) link("https://www.instagram.com/edgetronics/?hl=en");
    }
  }
}
