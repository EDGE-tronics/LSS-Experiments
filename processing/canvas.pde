...
void setup() {
  ...
  createList("COMmenu", width-65, headerHeight*0.7, 60, 3*30, Arrays.asList(" OFF", " ON"), 0);
  ...
  haltButton = createButton("STOP", "STOP", cp5.getController("BAUDmenu").getPosition()[0]-65, headerHeight*0.7, 60, 30);
...
void drawHeader() {
  ...
  text("EDGETRONICS", 20, 0.5*headerHeight);
}
